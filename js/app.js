...
let activetab = tab.querySelector("._active-tab");
let tabswrapper = tab.querySelector("._tabs-wrapper");
...
for (let index = 0; index < tabs_items.length; index++) {
	...
	if(tabs_item.classList.contains('_active') == true){
		activetab.style.cssText = `
			left: ${tabs_item.offsetLeft - 10}px;
			width: ${tabs_item.offsetWidth + 20}px;
			height: ${tabswrapper.offsetHeight}px;
		`;
	}
